...
var ContractorController = /** @class */ (function () {
    function ContractorController() {
        ...
        this.delete = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contractor_model_1.Contractor.findByIdAndUpdate(req.params.id, {
                            state: false,
                        }, { new: true })];
                    case 1:
                        results = _a.sent();
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contractor_model_1.Contractor.findById(req.params.id)];
                    case 1:
                        results = _a.sent();
                        res.status(200).send({ items: results });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        q = { state: true };
                        return [4 /*yield*/, contractor_model_1.Contractor.countDocuments(q)];
                    case 1:
                        total = _e.sent();
                        return [4 /*yield*/, contractor_model_1.Contractor.find({
                                $or: [{ name: r }],
                                $and: [{ state: true }],
                            })
                                .skip(Number(skip))
        ...
        this.getContractor = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var contractors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contractor_model_1.Contractor.find()];
                    case 1:
                        contractors = _a.sent();
                        res.status(200).send({ items: contractors });
                        return [2 /*return*/];
                }
            });
        }); };
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var created, name, newContractor, savedContractor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contractor_model_1.Contractor.findOne({ name: req.body.name })];
                    case 1:
                        created = _a.sent();
                        if (created)
                            return [2 /*return*/, res.status(401).send({ msg: "Ya fue creado" })];
                        name = req.body.name;
                        newContractor = new contractor_model_1.Contractor({
                            name: name,
                        });
                        return [4 /*yield*/, newContractor.save()];
                    case 2:
                        savedContractor = _a.sent();
                        res.status(200).send({ items: savedContractor });
                        return [2 /*return*/];
                }
            });
        }); };

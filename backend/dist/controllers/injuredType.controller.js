...
exports.InjuredTypeController = void 0;
...
var InjuredTypeController = /** @class */ (function () {
    function InjuredTypeController() {
        var _this = this;
        this.path = "/injuredType";
        ...
        this.delete = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injuredType_model_1.InjuredType.findByIdAndUpdate(req.params.id, {
                            state: false,
                        }, { new: true })];
                    case 1:
                        results = _a.sent();
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injuredType_model_1.InjuredType.findById(req.params.id)];
                    case 1:
                        results = _a.sent();
                        res.status(200).send({ items: results });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        q = { state: true };
                        return [4 /*yield*/, injuredType_model_1.InjuredType.countDocuments(q)];
                    case 1:
                        total = _e.sent();
                        return [4 /*yield*/, injuredType_model_1.InjuredType.find({
                                $or: [{ name: r }],
                                $and: [{ state: true }],
                            })
                                .skip(Number(skip))
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var name, newInjuredBodyPart, saved;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = req.body.name;
                        newInjuredBodyPart = new injuredType_model_1.InjuredType({
                            name: name,
                        });
                        return [4 /*yield*/, newInjuredBodyPart.save()];
                    case 1:
                        saved = _a.sent();
    ...
    return InjuredTypeController;
}());
exports.InjuredTypeController = InjuredTypeController;
//# sourceMappingURL=injuredType.controller.js.map
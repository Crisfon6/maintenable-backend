...
exports.InjuredBodyPartController = void 0;
...
var InjuredBodyPartController = /** @class */ (function () {
    function InjuredBodyPartController() {
        var _this = this;
        this.path = "/injuredBodyPart";
        ...
        this.delete = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injuredBodyPart_model_1.InjuredBodyPart.findByIdAndUpdate(req.params.id, {
                            state: false
                        }, { new: true })];
                    case 1:
                        results = _a.sent();
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injuredBodyPart_model_1.InjuredBodyPart.findById(req.params.id)];
                    case 1:
                        results = _a.sent();
                        res.status(200).send({ items: results });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        (cMean);
                        q = { state: true };
                        return [4 /*yield*/, injuredBodyPart_model_1.InjuredBodyPart.countDocuments(q)];
                    case 1:
                        total = _e.sent();
                        return [4 /*yield*/, injuredBodyPart_model_1.InjuredBodyPart.find({
                                $or: [{ name: r }],
                                $and: [{ state: true }],
                            })
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = req.body.name;
                        newInjuredBodyPart = new injuredBodyPart_model_1.InjuredBodyPart({
                            name: name
                        });
    ...
    return InjuredBodyPartController;
}());
exports.InjuredBodyPartController = InjuredBodyPartController;
//# sourceMappingURL=injuredBodyPart.controller.js.map
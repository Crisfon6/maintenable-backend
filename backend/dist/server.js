...
var Server = /** @class */ (function () {
    function Server(controllers) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mongoose_1.connect(uriDB, {
        ...
        this.middlewares = function () {
            ...
            _this.app.use(express_1.default.static("public"));
            _this.app.use(error_middleware_1.errorMiddleware);
        };
        // let routerTemp :Router = controller.router;
        this.setupPublic = function () {
            _this.app.use(express_1.default.static('public'));
        };
        this.routes = function (controllers) {
            controllers.forEach(function (controller) {
                var routerTemp = controller.router;
                _this.app.use('/api/', routerTemp);
            });

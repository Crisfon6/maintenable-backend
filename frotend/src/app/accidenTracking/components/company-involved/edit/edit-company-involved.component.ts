...
export class EditCompanyInvolvedComponent  {
    ...
    title = 'Editar empresa involucrada';
    contractors = [];
    id:string;
    constructor(
      private companyInvolvedService: CompanyInvolvedService,
    ...
    onSubmit() {
      ...
      this.companyInvolvedService.update(this.id,data).subscribe(
        (data) => {
